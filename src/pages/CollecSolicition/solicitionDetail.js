  ...
  render() {
    ...
    return <Row className="main-content">
        ...
        <Col span={24} className="solicition-detail" style={{ padding: "20px 40px 20px 20px" }}>
          ...
          <Col span={6} className="detail-box">
            文物图片: <img src={solicition.Collection_img1} style={{ width: "55px", height: "55px" }} alt="img" />
          </Col>
          <Col span={6} className="detail-box">
          ...
          <Col span={24} className="detail-box">
          ...
          <Col span={12} className="detail-box">
        ...
        {anthorityState === 1 && <ApproveComponent paramsId={solicition.Collection_Number} flag={1} changeAnthorityState={this.changeAnthority} />}
      </Row>;
  }
}
