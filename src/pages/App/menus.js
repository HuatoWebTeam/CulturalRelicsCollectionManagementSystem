export  const menus = [
    ...
    { key: 'CollecRepair', title: '修复管理', icon: 'iconBack repair', sub: [
        { key: '/App/CollectionRepair', title: '藏品修复', icon: 'nullIcon' },
        { key: '/App/Repairmaterials', title: '修复材料', icon: 'nullIcon' },
        { key: '/App/AddRepairmaterials', title: '藏品修复>修复材料>新增修复材料', fatherName:'/App/Repairmaterials' },
        { key: '/App/Repairmethod', title: '修复方法', icon: 'nullIcon' },
        { key: '/App/NewRepairMethod', title: '新增修复方法', icon: 'nullIcon', isHidden: true, fatherName: '/App/Repairmethod' },
        { key: '/App/Repairprocess', title: '修复过程', icon: 'nullIcon' },
        { key: '/App/Repairstatistics', title: '修复统计', icon: 'nullIcon' },
    ]},
